...
import 'package:e_commerce_dashboard/features/add_products/presentation/views/widgets/add_products_view_body_bloc_consumer.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child:  const Scaffold(
        body: AddProductsViewBodyBlocConsumer(),
      ),
    );
  }
}
